...
$cons_produtoid     = isset($_REQUEST['txt_cons_produtoid']) ? $_REQUEST['txt_cons_produtoid'] : '';
...
$sql = "select *, date_format(new_data_publicacao,'%d/%m/%Y') as data 
        ...
        where new_codigo like '%".$cons_codigo."%' AND
              ...
              new_autor like '%".$cons_autor."%' AND
              new_status like '%".$cons_status."%'
       ";
...
<form name="frm_consulta" action="consulta_news.php" method="post">
    ...
    <input name="txt_cons_status" type="text" placeholder="Autor">
