...
<div id="principal">
  <h1> Atualizar Fornecedor </h1>
    ...
    <label> Fone </label>
    <input name="txt_fone" type="number" class="input_01" value="<?php echo $dados['for_fone']; ?>">

    <label> Celular </label>
    <input name="txt_cel" type="number" class="input_01" value="<?php echo $dados['for_cel']; ?>">
